...
public class trackAnimaciones : MonoBehaviour
{
    ...
    void Start()
	{
		...
		experiencia4.onClick.AddListener(encenderAnimacionBloqueo);
		experiencia5.onClick.AddListener(encenderAnimacionBloqueo);
		experiencia6.onClick.AddListener(encenderAnimacionBloqueo);
		experiencia7.onClick.AddListener(encenderAnimacionBloqueo);
